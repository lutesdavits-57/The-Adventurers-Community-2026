...
# 🎮 The Adventurers — Community Edition

**Standalone Community Edition of The Adventurers — complete and ready to play.**
...
The Adventurers is an action-adventure RPG set in a handcrafted fantasy world of dungeons, ancient ruins, and open wilderness. Players assemble a party of heroes, complete quests, craft gear, and uncover the mystery of the Shattered Crown. This Community Edition is a standalone build that includes all content in a self-contained package, playable fully offline with no storefront or account required.

This build is for PC players who want a complete, offline-ready edition of The Adventurers without a storefront account.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3062500/15158377d6d602ebce050fbc0f524fd7d95980c4/ss_15158377d6d602ebce050fbc0f524fd7d95980c4.1920x1080.jpg?t=1788186695" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3062500/43532ec188155e6a4cb9c2a58b26af39967eaac9/ss_43532ec188155e6a4cb9c2a58b26af39967eaac9.1920x1080.jpg?t=1788186695" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3062500/f3fb860994fc304ce3c96cef1da47e334c5ca60f/ss_f3fb860994fc304ce3c96cef1da47e334c5ca60f.1920x1080.jpg?t=1788186695" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 🗺️ **Open World** — Explore a seamless fantasy continent with dungeons, villages, and hidden ruins.
- ⚔️ **Party-Based Combat** — Recruit and command a team of heroes in real-time tactical battles.
- 🛠️ **Crafting System** — Gather resources to forge weapons, armor, and consumable potions.
- 🌐 **Multiplayer** — LAN or direct connection supported for cooperative expeditions.
- 💾 **Offline Play** — Fully playable offline; no storefront, account, or additional software required.
- 📦 **Self-Contained Package** — Includes all content in a single independent release; no additional downloads needed.
- 🎮 **Controller Support** — Native gamepad support with fully remappable controls.
- 🌍 **Multiple Languages** — Interface localized in seven languages, including English, German, and Russian.

- **Compression:** Lossless
- **Install Time:** ~8 minutes on SSD, ~20 on HDD
- **Recoding:** none
- **Selective Download:** Bonus artbook and original soundtrack files can be skipped during download.

---

## 📦 DLCs Included

- The Adventurers: Frozen Peaks
- The Adventurers: Sunken Depths
- The Adventurers: Bard's Pack
...
| **RAM** | 8 GB | 16 GB |
| **Graphics** | NVIDIA GeForce GTX 960 / AMD Radeon R9 280X, 4 GB VRAM | NVIDIA GeForce RTX 2060 / AMD Radeon RX 5600 XT, 6 GB VRAM |
| **Storage** | 25 GB available space | 25 GB on SSD |
| **Additional** | DirectX 11 compatible sound card | Network adapter for LAN or direct connection multiplayer |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\TheAdventurers\Saved`
